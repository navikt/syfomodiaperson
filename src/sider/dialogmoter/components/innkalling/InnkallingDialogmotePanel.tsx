...
export default function InnkallingDialogmotePanel({
  ...
  const hasNoUbehandletMotebehov =
    !latestSubmittedMotebehov || !!latestSubmittedMotebehov.behandletTidspunkt;

  const shouldShowDialogmoteActions =
    hasNoUbehandletMotebehov || isLatestMoteFerdigstilt;
